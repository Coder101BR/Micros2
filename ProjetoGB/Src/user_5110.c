...
void LCD_Init(void) {
	  ...
	  LCD_Write_Command(0xBF); // Contraste
...
//  LCD_Write_Command(0xB0); //Set LCD Vop (Contrast): Try 0xB1(good @ 3.3V) or 0xBF if your display is too dark
...
//  LCD_Write_Command(0x0C); //Set display control, normal mode. 0x0D for inverse
//WTS##
